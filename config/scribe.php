...
return [
    ...
    // A short description of your API. Will be included in the docs.
    'description' => 'REST API for the HubAI dropshipping platform. Used by the Lovable frontend (hubai.io).',
    ...
    'routes' => [
        [
            ...
            'exclude' => [
                'GET /sanctum/csrf-cookie', 'livewire/*', '/admin/*', '/app/*', 'debugbar/*'
            ],
        ],
    ],
